...
<div class="d-flex">
  ...
  <aside class="sidebar p-3">
    ...
    <a href="../page/gallery.php" class="active"><i class="fa-solid fa-image me-2"></i> Gallery</a>
  ...
  <div class="main-content p-4 flex-grow-1">
    ...
    <div class="row g-3">
      ...
      <div class="col-md-4 col-sm-6">
        <div class="card shadow-sm">
          <div class="ratio ratio-16x9" data-bs-toggle="modal" data-bs-target="#mediaModal9">
            <iframe src="https://www.facebook.com/reel/" title="Car Wash Video" allowfullscreen></iframe>
          </div>
          <div class="card-body text-center">
            <p class="card-text">Car Polishing</p>
            <button class="btn btn-sm btn-danger">🗑 Delete</button>
          </div>
        </div>
      </div>
