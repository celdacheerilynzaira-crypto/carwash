    ...
    public function render() {
        ...
        <div class="d-flex">
            ...
            <aside class="sidebar p-3">
                ...
                <a href="#" class="active"><i class="fa-solid fa-home me-2"></i> Dashboard</a>
                <a href="#"><i class="fa-solid fa-calendar-check me-2"></i> Bookings</a>
                <a href="#"><i class="fa-solid fa-tags me-2"></i> Services</a>
                <a href="#"><i class="fa-solid fa-users me-2"></i> Customers</a>
                <a href="#"><i class="fa-solid fa-user-tie me-2"></i> Staff</a>
                <a href="#"><i class="fa-solid fa-star me-2"></i> Reviews</a>
                <a href="#"><i class="fa-solid fa-image me-2"></i> Gallery</a>
                <a href="#"><i class="fa-solid fa-envelope me-2"></i> Messages</a>
                <a href="#"><i class="fa-solid fa-chart-bar me-2"></i> Reports</a>
                <a href="#"><i class="fa-solid fa-cog me-2"></i> Settings</a>
            </aside>
